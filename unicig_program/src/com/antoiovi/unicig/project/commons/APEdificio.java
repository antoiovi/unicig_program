...
public class APEdificio extends JPanel  {
	 ...
	 * Create the panel.
	 */
	public APEdificio(Project project) {
		...
		//Imposta valore in base a valore di project
		spinnerNPiani.getModel().setValue(Integer.valueOf(project.getNpiani()));
		...
		gbc_lblSezioneCamino.gridy = 1;
		panel_1.add(lblSezioneCamino, gbc_lblSezioneCamino);
		
		JComboBox comboBoxSezione = new JComboBox();
		...
		panel_1.add(comboBoxSezione, gbc_comboBox);
		...
		gbc_lblCoefficienteDiCarico.gridy = 3;
