...
public class PCondotto extends JPanel implements ActionListener,APCondotto,ICondotto{
 ...
 */
	...
	public PCondotto() {
		...
		lbl_sottotitolo = new JLabel("Sottotitolo");
		panel_1.add(lbl_sottotitolo, "3, 3");
		
		lblNewLabel = new JLabel("Forma sezione");
		panel_1.add(lblNewLabel, "1, 5, left, default");
		panel_1.add(comboBoxSezione, "3, 5, fill, fill");
			/**
		...
		panel_1.add(spSviluppo, "3, 19, fill, fill");
		/**
		 * ALTEZZA
		 */
		...
		panel_1.add(spAltezza, "3, 21, fill, default");
		/**
		...
		panel_1.add(spCoefflimest, "3, 23, fill, default");
		/**
		 * PERDITE LOCALIZZATE
		 */
		...
		panel_1.add(spPerdite, "3, 25");
	
		lblTemperaturaEsternac = new JLabel("Temperatura esterna [\u00B0C]");
		panel_1.add(lblTemperaturaEsternac, "1, 27, right, default");
		
		textTempesterna = new JTextField();
 ...
 */
	...
	public void setSottotitolo(String sottotitolo) {
		...
		this.lbl_sottotitolo.setText(sottotitolo);
	}
	...
	private JTextField textTempesterna;
	private JLabel lbl_sottotitolo;
