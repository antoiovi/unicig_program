...
public class APanelCondLabel extends JPanel {
	...
	private JTextField txtSingoloconcentrico;
	...
	//	df.setDecimalFormatSymbols(dot_decimal);
		...
		panel_1.add(lblNewLabel_7, "1, 21, fill, fill");
		
		JTextField lblAltezza = new JTextField("Altezza");
		lblAltezza.setEditable(false);
		panel_1.add(lblAltezza, "1, 23, fill, default");
		...
		panel_1.add(lblCoefficenteLaminareEsterno, "1, 25");
		...
		panel_1.add(txtPerditeLocalizzate, "1, 27, fill, default");
