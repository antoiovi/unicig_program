...
public class APCondotti extends JPanel {
	...
	public APCondotti (APanel_Unicig _panelProject) {
		this.panelProject=_panelProject;
		addComponentListener(new ComponentAdapter() {
			@Override
			public void componentHidden(ComponentEvent e) {
				panelProject.panelHidden(IMenu.condotti);
				log("HIDDEN");
			}
		});
		...
		// Roughness 
		JLabel lblRough = new JLabel("Roughness [ mm ]");
		...
		spinnerT = new JSpinner(new SpinnerNumberModel(0.5, 0.1, 160.0, 0.1));
		panel2.add(lblTherm);
		panel2.add(spinnerT);
		...
		// Set Title
		JLabel title = new JLabel("Chimney segments ");
